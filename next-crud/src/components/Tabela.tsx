    ...
    const renderizarAcoes = (cliente: Cliente) => {
        return(
            <td className="flex justify-center">
                {clienteSelecionado ? (
                    <button onClick={() => clienteSelecionado?.(cliente)} className="flex justify-center items-center
                ...
                {clienteExcluido ? (
                     <button onClick={() => clienteExcluido?.(cliente)} className="flex justify-center items-center
